...
REM set "log_file=G:\test_1\t_job_2_string.log"
REM set "log_file=C:\some path\your bak dir\any your bakname.log.txt"

REM Maximum number of records in log_file
...
set "mbt_log_note=_dev.job.2.0.1"
...
REM set "_mbt_this_bat_name=mbt_2.1---job---test-notfind"
set "_mbt_this_bat_name=mbt_2.1---job---delete test b1---G##test_1"
REM set /a mbt_debug_level=0
...
REM echo. "mbt_debug_level %mbt_debug_level%"

if "%_arg_1%" == "" goto check_log_file
...
REM if arg_1 in "0,1,2,3,4"
call:is_str_cludes ",0,1,2,3,4,5," ",%_arg_1%,"
if "!_is_str_cludes!" NEQ  "" (
  if "%mbt_debug_level%" == "" set /a mbt_debug_level=%_arg_1%
)
...
if "%mbt_debug_level%" == "" set /a mbt_debug_level=4
...
REM mbt_2.1---job---test 1---#g##test#dir in test.bat

set /a _mbt_this_bat_pre_len_2=%_mbt_this_bat_pre_len%+1

REM if mbt_version_major = 2.x
if "!_mbt_this_bat_name:~%_mbt_this_bat_pre_len_2%,1!"=="." (
  set "mbt_version_major=!_mbt_this_bat_name:~%_mbt_this_bat_pre_len%,3!"
  set /a _mbt_this_bat_pre_len=%_mbt_this_bat_pre_len%+3
  goto check_bat_right
)

REM echo. "----0 !_mbt_this_bat_name:~%_mbt_this_bat_pre_len%!"
REM echo. "-----1 !_mbt_this_bat_name:~%_mbt_this_bat_pre_len_2%,1!"
REM echo. "-----1 !_mbt_this_bat_name:~%_mbt_this_bat_pre_len%,1!"
REM goto :EOF

REM check version in thi_bat_name 
