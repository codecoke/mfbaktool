...
set "mbt_allow_ac_type=info,job,bylist,cmd"
...
set "mbt_caller_bat=mbt_2.0---info---delete test b1---C##test_1"
set "mbt_caller_bat=mbt_2.0---info---show vars info"
