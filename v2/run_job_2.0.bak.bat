...
REM run_job_2.bat
REM version 2.0.0
REM w(a)ibar.cn 2024-08-31 12:45:30
...
set "_bat_file_name=%_bat_file_name:~4%"

REM echo. "_bat_file_name:%_bat_file_name%"


set "_bat_name_end=%_bat_file_name:~-2%"

REM run_job_2.bat  ac_type is substring job
REM run_[ac_type]_[mbt_version_major].bat
...
REM set "mbt_log_note=_dev/v2 :ver.%mbt_version_major%_%mbt_script_version%"
